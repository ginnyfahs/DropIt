...
{
    // guts of doing an attachment
    if (self.droppingView) {
        self.attachment = [[UIAttachmentBehavior alloc] initWithItem:self.droppingView attachedToAnchor:anchorPoint];
        UIView *droppingView = self.droppingView;
        // prevent memory cycle by creating a local version of self that is weak and calling weakSelf in block
        ...
        // not allowed to grab onto the same square twice
